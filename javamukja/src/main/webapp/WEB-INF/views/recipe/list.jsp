		...
		<div class="container-wrap">
			<div class="row no-gutters d-flex">
				<c:forEach var="dto" items="${list}">
					<div class="col-lg-4 d-flex ftco-animate" style="border:solid 3px; border-color:#fac564;">
						<div class="services-wrap d-flex">
							...
							<div class="text p-4">
								...
								<p class="price">
									<span>${dto.rdate }</span>
									<br>
									<c:set var="rcount" value="${util:rcount(dto.rno,rrinter)}"/>
									<a class="btn btn-outline-warning" style="width:125px;"
										href="javascript:readR('${dto.rno}')">Read Go! <span class="badge" style="font-size:110%; color:#000000; background-color:#d3ab19;"> ${rcount}</span></a>
										<br>
									<a class="btn btn-outline-danger"
										href="javascript:recomR('${dto.rno}')">♡ ${dto.rcnt }</a>
									<a class="btn btn-outline-success"
										href="javascript:readR('${dto.rno }')">${dto.viewcnt } 조회</a>
								</p>
								<br>
							</div>
						</div>
