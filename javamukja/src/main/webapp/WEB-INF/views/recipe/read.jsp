...
<body>
	<div class="container">
					...
					<c:choose>
						<c:when test="${files[i]=='0'}">
							<td class="td_padding" align="center"><img
								src="./storage/X.jpg" width="150px" height="120px"></td>
						</c:when>
						<c:otherwise>
							<c:choose>
								<c:when test="${noArr[i]==dto.rno}">
									<td class="td_padding" align="center"><a
										href="javascript:readR('${noArr[i]}')"> <img
											...
											height="120px" border="3">
									</a></td>
								</c:when>
								<c:when test="${files[i]==null}">
									<td class="td_padding" align="center"> 
									<img src="./storage/X.jpg" width="150px" height="120px" border="0">
									</td>
								</c:when>
								<c:otherwise>
									<td class="td_padding" align="center"><a
		...
		<div align="center"><img src="./storage/${dto.fname}" class="img-thumbnail" width="460px"
					height="340px"></div><br>
