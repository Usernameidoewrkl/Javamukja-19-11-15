...
color: #fac564;
    ...
    <script type="text/javascript">
		...
		var j = 1;
		for(i=0; i<10 ; i++){
			$('#b').append("<a style=backgroundcolor: #f8f9fa; href='"+link+data[i].fstr+"'>"+"【"+(j++)+"위_"+data[i].fstr+"】</a>");
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
			...
			<div style="width=460px; height=32px; left: 200px position:">
...
<%-- 	          <li class="nav-item"><a href="${root }/rank/list" class="nav-link">RANK</a></li> --%>
	   <!--   <ul class="navbar-nav ml-auto"> -->
	         ...
	         <li class="nav-item active"><a class="nav-link" href="${root}/member/login">Login</a></li>
	          ...
	          <c:otherwise>
	          <li class="nav-item active"><a class="nav-link" href="${root}/member/read">My Page</a></li>	       
	          <li class="nav-item active"><a class="nav-link" href="${root}/member/logout">Logout</a></li>
	          </c:otherwise>
	          </c:choose>
