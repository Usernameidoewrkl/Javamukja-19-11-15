        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="${root }/recipe/list" class="btn btn-primary p-3 px-xl-4 py-xl-3">레시피 게시판</a> <a href="${root }/talk/list" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3"> 자유 톡! </a></p>
            </div>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 ftco-animate">
              ...
              <h1 class="mb-4">제육볶음</h1>
              <p class="mb-4 mb-md-5">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              <p><a href="${root }/recipe/list?col=title&word=제육볶음" class="btn btn-primary p-3 px-xl-4 py-xl-3">레시피 보러가기</a> <a href="${root }/talk/list" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3"> 자유 톡! </a></p>
            </div>
            <div class="col-md-6 ftco-animate">
            	<img src="images/제육볶음2.jpg" class="img-fluid" alt="">
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 order-md-last ftco-animate">
            	<span class="subheading">Delicious</span>
              <h1 class="mb-4">떡볶이</h1>
              <p class="mb-4 mb-md-5">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">레시피 보러가기</a> <a href="${root }/talk/list" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3"> 자유 톡! </a></p>
            </div>
            <div class="col-md-6 ftco-animate">
            	<img src="images/떡볶이.jpg" class="img-fluid" alt="">
            </div>
...
<div class="slider-item">
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 ftco-animate">
            	<img src="images/냉면.jpg" class="img-fluid" alt="">
<!--             	<img src="images/bg_1.png" class="img-fluid" alt=""> -->
            </div>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">Various Recipes</h3>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
              </div>
            </div>    
          </div>
...
<!--     </section> -->
	<section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">Welcome to <span class="flaticon-pizza">JavaMukja</span> A Recipe Comunity</h2>
        </div>
        <div>
		          ...
		          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		              	...
		              	<strong class="number" data-number="${memCnt}">0</strong>
		              	<span>회원 수</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		              	...
		              	<strong class="number" data-number="${totalCnt }">0</strong>
		              	<span>게시글 수</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		              	...
		              	<strong class="number" data-number="${admCnt}">0</strong>
		              	<span>쉐프</span>
		              </div>
		            </div>
		          </div>
