...
public class MemberController {
	...
	public String nickCheck(String nickname, HttpSession session) {
		...
		if (flag == 1) {
			str = nickname + "는(은) 이미 다른사용자가 사용중인 닉네임입니다.";
		} else {
			str = nickname + "는(은) 사용할 수 있는 닉네임입니다.";
		}
	...
	public String read(String id, HttpSession session, Model model, 
		...
		if (request.getParameter("nowPage") == null) {
			int nowPage=1; 
			return "redirect:/member/read?nowPage="+nowPage;
		}else{			
		}		
		return "/member/read";
	}
	...
	public String updateFile(String id, MemberDTO dto, HttpServletRequest request, HttpSession session, RedirectAttributes redi) {
		
//		 String grade = (String) request.getSession().getAttribute("grade");
//		String id2 = (String) request.getSession().getAttribute("id");
//		
//		if(grade.equals("A") || id2==request.getParameter("id")) {
//		if(grade.equals("A") || id2==request.getSession().getAttribute("id")) {
//	
//			return "/member/updateFile";			
//		}else{
//			return "redirect:/member/read?id="+id2;
//		}
	...
	public String updateFile(String id, String oldfile, MultipartFile fnameMF, HttpServletRequest request,HttpSession session,
			RedirectAttributes redi) {
